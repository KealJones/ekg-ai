...
declare module "node:child_process" { export const spawnSync:any; export const execSync:any; }
...
declare module "node:readline/promises" { export type Interface=any; export const createInterface:any; }
